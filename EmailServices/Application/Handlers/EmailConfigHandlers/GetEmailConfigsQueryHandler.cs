...
public class GetEmailConfigsQueryHandler
    : IRequestHandler<GetEmailConfigsQuery, IEnumerable<EmailConfigDTO>>
{
    ...
    public async Task<IEnumerable<EmailConfigDTO>> Handle(
        GetEmailConfigsQuery q,

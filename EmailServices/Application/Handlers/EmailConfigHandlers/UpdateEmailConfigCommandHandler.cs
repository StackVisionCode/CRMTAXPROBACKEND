    ...
    : IRequestHandler<UpdateEmailConfigCommand, EmailConfigDTO>
{
  ...
  public UpdateEmailConfigCommandHandler(EmailContext ctx, IMapper map, ILogger<UpdateEmailConfigCommandHandler> log, IEmailConfigValidator validator)
  {
    _ctx = ctx;
    _map = map;
    _log = log;
  ...
  public async Task<EmailConfigDTO> Handle(UpdateEmailConfigCommand r,

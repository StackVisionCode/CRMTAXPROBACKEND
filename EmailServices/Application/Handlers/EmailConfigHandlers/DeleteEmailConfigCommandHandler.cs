...
public class DeleteEmailConfigCommandHandler : IRequestHandler<DeleteEmailConfigCommand, Unit>
{
    ...
    public DeleteEmailConfigCommandHandler(EmailContext ctx, ILogger<DeleteEmailConfigCommandHandler> log)
    {
        _ctx = ctx;
        _log = log;
    }
    ...
    public async Task<Unit> Handle(DeleteEmailConfigCommand r, CancellationToken ct)
    {
        ...
        if (entity is null) throw new KeyNotFoundException("Config not found");

    ...
    : IIntegrationEventHandler<AccountConfirmationLinkEvent>
{
    ...
    private readonly ILogger<AccountConfirmationLinkHandler> _logger;

    public AccountConfirmationLinkHandler(
        IMediator mediator,
        IWebHostEnvironment env,
        ILogger<AccountConfirmationLinkHandler> logger
    )
    {
        _mediator = mediator;
        _env = env;
        ...
        try
        {
            ...
            var dto = new EmailNotificationDto(
                ...
                Subject: evt.IsCompany
                    ? "Welcome to TAXPRO SHIELD - Confirm Your Tax Firm"
                    : "Welcome to TAXPRO SHIELD - Confirm Your Account",
                To: evt.Email,

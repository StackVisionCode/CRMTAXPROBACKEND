...
public sealed class UserCompanyInvitationSentHandler
    : IIntegrationEventHandler<UserCompanyInvitationSentEvent>
{
    private readonly IMediator _mediator;
    private readonly IWebHostEnvironment _env;
    private readonly ILogger<UserCompanyInvitationSentHandler> _logger;

    public UserCompanyInvitationSentHandler(
        IMediator mediator,
        IWebHostEnvironment env,
        ILogger<UserCompanyInvitationSentHandler> logger
    )
    {
        _mediator = mediator;
        _env = env;
    ...
    public async Task Handle(UserCompanyInvitationSentEvent evt)
    {
        try
        {
    ...
    private static string DetermineCompanyDisplayName(UserCompanyInvitationSentEvent evt)
    {

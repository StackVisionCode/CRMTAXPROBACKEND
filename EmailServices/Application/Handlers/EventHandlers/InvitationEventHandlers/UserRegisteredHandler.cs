...
public sealed class UserRegisteredHandler : IIntegrationEventHandler<UserRegisteredEvent>
{
    ...
    private static string DetermineEmployeeName(UserRegisteredEvent evt)
    {
    ...
    private static string DetermineCompanyDisplayName(UserRegisteredEvent evt)
    {

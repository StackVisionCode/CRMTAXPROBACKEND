...
public sealed class LandingActivatedEmailHandlers : IIntegrationEventHandler<AccountConfirmedEvent>
{
    private readonly IMediator _mediator;
    private readonly IWebHostEnvironment _env;
    private readonly ILogger<LandingActivatedEmailHandlers> _logger;

    public LandingActivatedEmailHandlers(
        IMediator mediator,
        IWebHostEnvironment env,
        ILogger<LandingActivatedEmailHandlers> logger
    )
    {
        _mediator = mediator;
        _env = env;

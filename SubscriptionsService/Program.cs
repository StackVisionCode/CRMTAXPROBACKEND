...
try
{
    ...
    {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "SubscriptionsService API", Version = "v1" });
    ...
    var connectionString =
        $"Server={objetoConexion.Server};Database=SubscriptionDB;User Id={objetoConexion.User};Password={objetoConexion.Password};TrustServerCertificate=True;";
